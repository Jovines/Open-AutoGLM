...
7. Get launchable app mapping as JSON (label/package/activity)
adb shell am broadcast -n com.android.adbkeyboard/.AppListReceiver -a ADB_LIST_APPS

7.1 Include system apps and increase result limit
adb shell am broadcast -n com.android.adbkeyboard/.AppListReceiver -a ADB_LIST_APPS --ez include_system true --ei limit 2000

* Result JSON is returned in ordered broadcast `data` and extras key: `apps_json`
